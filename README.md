...
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/skeptycal/tos/Go) ![Codecov](https://img.shields.io/codecov/c/github/skeptycal/tos)
...
```sh
gh repo create -y --public --template "https://github.com/skeptycal/tos"
```
...
go get github.com/xxxxxx/tos

cd ${GOPATH}/src/github.com/xxxxxx/tos
...
> This is a copy of the example script available in the `cmd/example/tos` folder:

```go
package main

import "github.com/skeptycal/tos"
...
[issues]: (https://github.com/skeptycal/tos/issues)
[pr]: (https://github.com/skeptycal/tos/pulls)
